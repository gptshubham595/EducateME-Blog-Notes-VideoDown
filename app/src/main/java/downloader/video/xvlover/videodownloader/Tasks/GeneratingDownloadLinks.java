...
import downloader.video.xvlover.videodownloader.utils.JSONParser;
import downloader.video.xvlover.videodownloader.utils.Session;
...
//    }
    ...
    public static void GenerateDownloadUI(JSONObject result) throws JSONException {
        ...
        dialog.setContentView(R.layout.download_dialogdown);
